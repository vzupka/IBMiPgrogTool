...
Version 06.02 May 2026

- Added button "Library list" in the main window.
- Added horizontal split of the editor area.
...
Verze 06.02 Květen 2026

- Přidáno tlačítko "Library list" v hlavním okně,
- Přidáno horizontální rozdělení oblasti editoru.
