...
public class ChangeLibraryList extends JFrame {
    ...
    // Lists 
    JList<String> listLeft = new JList(listModel);
...
System.out.println("itemsLeft.size(): "+itemsLeft.size());
...
System.out.println("itemsLeft.get(idx) 1: "+itemsLeft.get(idx));
                ...
                if (! foundInRight) {
                    if (index == null) {
System.out.println("itemsLeft.get(idx) 2: "+itemsLeft.get(idx));
