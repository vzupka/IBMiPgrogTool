...
/*        
        wrkSplFCall = new WrkSplFCall(remoteServer, mainWindow, this.pathString,
                true, // *CURRENT user
                compileWindowX, compileWindowY, this.getClass().getSimpleName(),
...
*/
        ...
        commandTextArea.setLineWrap(true);  // Wrap longer line
        commandTextArea.setWrapStyleWord(true);  // Maintain whole words intact
        ...
        changeLibraryListButton.addActionListener((var en) -> {
            ...
            new ChangeLibraryList(this.remoteServer, compileWindowX, compileWindowY);
        });
    ...
    private void getAppProperties() {
        ...
        super.setTitle("Compile  '" + pathString + "'");  // Title on top of the window
    }
