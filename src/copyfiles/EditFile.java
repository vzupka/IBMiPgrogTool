...
public final class EditFile extends JFrame {
    ...
    static final Color YELLOW_LIGHT = Color.getHSBColor(0.18f, 0.30f, 0.99f);
...
/*        
        ...
        if (selectionModeButton.getText().equals(HORIZONTAL_SELECTION)) {
            ...
            if (caretShape.equals(LONG_CARET)) {
                // Long caret
                textArea2.setCaret(longCaret);
            } else {
                // Short caret
                textArea2.setCaret(shortCaret);
            }
        } else {
            // Vertical selection
            textArea2.setCaret(specialCaret);
        }
*/
